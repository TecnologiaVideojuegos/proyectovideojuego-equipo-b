...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.player.stand_left_textures.append(
            arcade.load_texture("WalkingX.png", x=0, y=0, width=240, height=520, mirrored=True))
        ...
        for i in range(7):
            self.player.walk_right_textures.append(
                arcade.load_texture("WalkingX.png", x=i * 236 + 50, y=0, width=220, height=522))

        # Walk Left Sprites
        self.player.walk_left_textures = []
        for i in range(7):
            self.player.walk_left_textures.append(
                arcade.load_texture("WalkingX.png", x=i * 236 + 50, y=0, width=220, height=520, mirrored=True))
