...
class Scenario(arcade.Window):
    ...
    def setup(self):
        ...
        light_placed_successfully = False

        light = arcade.Sprite(":resources:images/items/coinGold.png", 0.5)

        while not light_placed_successfully:
            light.center_x = SCREEN_WIDTH // 1.25
            light.center_y = SCREEN_HEIGHT // 2
        # -- Set up the walls
